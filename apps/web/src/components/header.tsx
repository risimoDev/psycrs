      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:hidden">
          ...
          <button
            ...
            className="flex items-center rounded px-2 py-1.5 text-sm font-medium text-foreground/70 transition-colors hover:bg-foreground/5"
            aria-label={mobileOpen ? 'Закрыть меню' : 'Открыть меню'}
          >
            {mobileOpen ? (
              <svg width="18" height="18" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" className="mr-1">

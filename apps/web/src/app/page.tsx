  ...
  const categories = [
    {
      ...
      items: [
        'Глубокие лекции по самым проблемным и актуальным тематикам.',
        'Психология здоровых отношений',
        'Поиск подходящего партнера',
        'Личные границы',
        'Созависимость',
        'Тревожность',
        'Психология успеха и многое другое',
      ],
    ...
    },
    {
      ...
      items: [
        'Скорая помощь “здесь и сейчас”',
        'Аудио установки для ежедневной практики',
        'Утренние и вечерние практики',
        'Работа с внутренним диалогом',
        'Техники осознанности',
        'Изменения настроек подсознания',
      ],
    ...
    },
    {
      ...
      items: [
        'Авторские научно популярные статьи в текстовом формате',
        'Информативные лекции в текстовом формате',
        'Актуальные стратегии',
        'Свежие тренды в психологии',
        'Схематичные чек листы',
        'Кейсы', 
      ],
    ...
    <section id="tariffs" className="bg-warm/30 py-20">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <p className="mt-6 text-center text-sm text-muted">
          Есть промокод? Введите его при выборе тарифа и получите скидку
        </p>
      </div>
    </section>
  );
